...
export default GObject.registerClass(class GpuActivityBars extends BarsBase {
    constructor(params) {
        if (params.layers === undefined)
            params.layers = 1;
        super(params);
        Config.connect(this, 'changed::gpu-header-activity-bar-color1', this.setStyle.bind(this));
    }
    setStyle() {
        super.setStyle();
        this.colors = [
