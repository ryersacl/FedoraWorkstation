...
export default GObject.registerClass(class NetworkGraph extends GraphBase {
    constructor(params) {
        super(params);
    ...
    setStyle() {
        ...
        if (this.maxUploadSpeedLabel) {
            if (lightTheme)
                ...
                this.maxUploadSpeedLabel.styleClass = 'astra-monitor-graph-label';
        }
        if (this.maxDownloadSpeedLabel) {
            if (lightTheme)
                this.maxDownloadSpeedLabel.styleClass = 'astra-monitor-graph-label-light';
            else
                this.maxDownloadSpeedLabel.styleClass = 'astra-monitor-graph-label';
        }
        if (this.thenLabel) {
            if (lightTheme)
